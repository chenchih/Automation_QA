...
public class LoginTests {
	 ...
	 * incorrectUsernameTest() { //create driver
	 * 
	 * //----------------Chrome-------------------------------
	 ...
	 * username.sendKeys("incorrectUsernameTest"); sleep(1000); //enter password
	 * WebElement password =driver.findElement(By.name("password"));
	 * password.sendKeys("SuperSecretPassword!"); sleep(3000); //click login button
	 * WebElement logInButton =driver.findElement(By.tagName("button"));
