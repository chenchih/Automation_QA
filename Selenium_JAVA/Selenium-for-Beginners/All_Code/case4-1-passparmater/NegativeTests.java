...
public class NegativeTests {
	 ...
	 * incorrectPasswordTest() { //create driver
	 ...
	 * username.sendKeys("tomsmith"); sleep(1000); //enter password WebElement
	 * password =driver.findElement(By.name("password"));
	 * password.sendKeys("incorrectPassword"); sleep(3000); //click login button
	 * WebElement logInButton =driver.findElement(By.tagName("button"));
