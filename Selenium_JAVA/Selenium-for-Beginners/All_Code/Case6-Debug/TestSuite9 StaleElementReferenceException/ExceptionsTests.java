...
public class ExceptionsTests {
	...
	public void staleElementTest() {
		...
		//Assert.assertTrue(wait.until(ExpectedConditions.invisibilityOf(checkbox)), "Checkbox is still visible, but shouln't be");
		...
		//Assert.assertTrue(checkbox.isDisplayed(), "Checkbox is not visble, but it shiould be  ");
